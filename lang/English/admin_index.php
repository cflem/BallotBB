...
'json decode not found message'			=>	'Unable to check for upgrade since the JSON extension was not found on this system.',
'Upgrade check failed message'		=>	'Check for upgrade failed for unknown reasons.',
'Running latest version message'	=>	'You are running the latest version of BallotBB.',
'New version available message'		=>	'A new version of BallotBB has been released. You can download the latest version at %s.',
'Not available'						=>	'Not available',
'Forum admin head'					=>	'Forum administration',
'NA'								=>	'N/A',
'Welcome to admin'					=>	'Welcome to the BallotBB administration control panel. From here you can control vital aspects of the board. Depending on whether you are an administrator or a moderator you can:',
...
'About head'						=>	'About BallotBB',
'BallotBB version label'				=>	'BallotBB version',
