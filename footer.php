...
?>
				<p id="poweredby"><?php printf($lang_common['Powered by'], '<a href="https://github.com/GeonoTRON2000/BallotBB">BallotBB</a>'.(($pun_config['o_show_version'] == '1') ? ' '.$pun_config['o_cur_version'] : '')) ?></p>
			</div>
